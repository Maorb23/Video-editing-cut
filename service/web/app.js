(() => {
  ...
  function signedIn(user) {
    ...
    el("landing-panel").classList.add("hidden"); el("app-shell").classList.remove("hidden");
  ...
  function openEditor() { stopPolling(); refreshSequence++; editId = null; activePlan = null; selectedIteration = null; show("start-panel"); }
